      ...
      <div className="flex justify-center max-h-screen relative">
        <form className="border-primary border-solid border-2 rounded-lg h-fit my-auto p-5 w-full lg:w-2/3" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between items-center my-2">
            ...
            <button className="text-secondary font-bold underline italic" type="button" onClick={() => navigate('/forgot-password/email')}>
              Forgot Password?
            </button>
          </div>
          <Button type="button" className="text-xl" onClick={() => navigate('/signup')}>
            Create Account
          </Button>
        </form>
      </div>
